...
class FormRegister extends Model{
    ...
    {
        return [
            [['username', 'nombre','apellido', 'fecha_nacimiento', 'email', 'password', 'password_repeat'], 'required', 'message' => 'Campo requerido'],
           // ['fecha_nacimiento','date', 'message' => 'fecha de nacimiento con el siguiente formato YYYY/MM/DD'],
